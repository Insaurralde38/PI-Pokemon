          ...
          { form.types?.map((type) => {
            ...
            return (
              <span key={type} className="delete-type-cont">
                <img className="type" src={cardLogo}  onClick={() => handleDelete(type)} alt="" />
              </span>
            )})}
        </div>
